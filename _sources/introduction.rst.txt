...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first section, *Aria* has the following files:
